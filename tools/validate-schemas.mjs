...
const files=['schemas/domain/config.schema.json','schemas/domain/project.schema.json','schemas/domain/activity-type.schema.json','schemas/domain/tag.schema.json'];
